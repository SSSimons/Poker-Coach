"""Kivy recipe without optional HTTP helpers unused by this application.

The trainer uses urllib from the standard library, so Kivy's optional
requests/filetype dependencies are unnecessary for this application.
"""
